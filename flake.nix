...
{
  description = "Nix flake for pythoneda-realm-rydnr/realm";
  inputs = rec {
  ...
  outputs = inputs:
    ...
    flake-utils.lib.eachDefaultSystem (system:
      let
        ...
        repo = "realm";
        version = "0.0.7";
        sha256 = "1056j9mjy2z1sy7gbmhi4ij961w1510hscpq11cas0kqli80pq3r";
        pname = "${org}-${repo}";
        ...
        pythoneda-realm-rydnr-realm-for = { python, pythoneda-realm-rydnr-events
          ...
          in python.pkgs.buildPythonPackage rec {
            ...
            postInstall = with python.pkgs; ''
              ...
              for dep in ${pythoneda-shared-artifact-events} ${pythoneda-shared-artifact-shared} ${pythoneda-shared-code-requests-shared} ${pythoneda-shared-git-shared} ${pythoneda-shared-pythonlang-domain}; do
      ...
      in rec {
        ...
        devShells = rec {
          default = pythoneda-realm-rydnr-realm-python312;
          ...
          pythoneda-realm-rydnr-realm-python312 = shared.devShell-for {
            banner = "${
                pythoneda-shared-pythonlang-banner.packages.${system}.pythoneda-shared-pythonlang-banner-python312
              }/bin/banner.sh";
            extra-namespaces = "";
            nixpkgs-release = nixpkgsRelease;
            package = packages.pythoneda-realm-rydnr-realm-python312;
          ...
          pythoneda-realm-rydnr-realm-python313 = shared.devShell-for {
            banner = "${
                pythoneda-shared-pythonlang-banner.packages.${system}.pythoneda-shared-pythonlang-banner-python313
              }/bin/banner.sh";
            extra-namespaces = "";
            nixpkgs-release = nixpkgsRelease;
            package = packages.pythoneda-realm-rydnr-realm-python313;
        ...
        packages = rec {
          ...
          pythoneda-realm-rydnr-realm-python312 =
            pythoneda-realm-rydnr-realm-for {
              python = pkgs.python312;
              pythoneda-realm-rydnr-events =
          ...
          pythoneda-realm-rydnr-realm-python313 =
            pythoneda-realm-rydnr-realm-for {
              python = pkgs.python313;
              pythoneda-realm-rydnr-events =
